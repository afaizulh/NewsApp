...
import com.faizul.newsapp.databinding.FragmentMusicBinding
...
class MusicFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (commonNewsViewModel.musicNews.value == null){
            commonNewsViewModel.getMusicNews()
        }

        commonNewsViewModel.musicNews.observe(viewLifecycleOwner) {dataNews ->
