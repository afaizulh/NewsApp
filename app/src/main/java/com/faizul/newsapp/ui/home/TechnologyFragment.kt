...
import com.faizul.newsapp.databinding.FragmentTechnologyBinding
...
class TechnologyFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (commonNewsViewModel.technologyNews.value == null){
            commonNewsViewModel.getTechnologyNews()
        }

        commonNewsViewModel.technologyNews.observe(viewLifecycleOwner) {dataNews ->
